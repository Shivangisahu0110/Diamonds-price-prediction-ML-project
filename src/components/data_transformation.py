...
class DataTransformation:
    ...
    def initiate_data_transformation_object(self,train_path,test_path):
        try:
            ...
            drop_clumns = [target_column_name, "id"]

            # INDEPENDENT and DEPENDENT Features
            input_feature_train_df = train_df.drop(columns = drop_clumns,axis= 1)
            target_feature_train_df = train_df[target_column_name]

            input_feature_test_df = test_df.drop(columns= drop_clumns, axis = 1)
